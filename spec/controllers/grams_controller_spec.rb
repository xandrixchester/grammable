...
RSpec.describe GramsController, type: :controller do
	...
	describe "grams#destroy action" do
		...
		it "shouldn't allow users who didnt't create the gram to destroy it" do
	...
	describe "grams#update action" do
		...
		it "shouldn't let users who didnt't create the gram update it" do
			gram = FactoryBot.create(:gram)
			user = FactoryBot.create(:user)
			sign_in user
	...
	describe "grams#create action" do
      ...
      sign_in user
		...
		it "should propery deal with validation errors" do
		  user = FactoryBot.create(:user)
      sign_in user
